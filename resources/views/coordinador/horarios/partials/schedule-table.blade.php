...
<div class="scheduler-workspace">
    <div class="scheduler-board-panel">
        <div class="scheduler-board-head">
            @include('coordinador.horarios.partials.legend')
        </div>

        <div class="academic-schedule">
            <div class="academic-schedule-title" id="coord-horarios-schedule-title">TODOS LOS PROGRAMAS</div>
            <div class="academic-schedule-subtitle" id="coord-horarios-schedule-subtitle">{{ $periodos->firstWhere('estado', 'ACTIVO')?->codigo ?? '' }}</div>
