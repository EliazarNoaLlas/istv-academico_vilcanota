<div class="coord-horarios-modal-backdrop" id="coord-horarios-modal">
    <div class="coord-horarios-modal">
        <h2 id="coord-horarios-modal-title">Nuevo bloque</h2>

        <div class="coord-horarios-form-error" id="coord-horarios-form-error"></div>

        <form id="coord-horarios-form">
            ...
            <div class="form-group">
                ...
                <select name="_bloque" id="coord-horarios-select-bloque" required>
            ...
            <div class="coord-horarios-modal-actions">
                <button type="button" class="c-btn c-btn-outline" id="coord-horarios-modal-cerrar">Cancelar</button>
