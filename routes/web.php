...
use App\Http\Controllers\Coordinador\CoordinadorRevisionController;
...
Route::middleware(['auth', 'role:coordinador', 'coordinador.programa'])->prefix('api/coordinador')->group(function () {
    ...
    Route::get('/portafolios/asistencia', [CoordinadorPortafolioController::class, 'asistenciaPorFecha']);
    Route::post('/portafolios/asistencia', [CoordinadorPortafolioController::class, 'guardarAsistencia']);
    Route::get('/portafolios/revision/sesiones', [CoordinadorRevisionController::class, 'sesiones']);
    Route::post('/portafolios/revision/sesiones/{sesion}/validar', [CoordinadorRevisionController::class, 'validarSesion']);
    Route::get('/portafolios/revision/asistencia/fechas', [CoordinadorRevisionController::class, 'fechasAsistencia']);
    Route::get('/portafolios/revision/asistencia', [CoordinadorRevisionController::class, 'asistencia']);
    Route::get('/portafolios/revision/notas', [CoordinadorRevisionController::class, 'notas']);
    Route::post('/portafolios/revision/notas', [CoordinadorRevisionController::class, 'guardarNotas']);
    Route::post('/portafolios/revision/notas/reabrir', [CoordinadorRevisionController::class, 'reabrirNotas']);
